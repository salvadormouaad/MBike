...
function Section_Clothes() {
    ...
    // Filter for clothes (categoryId: 3 for "Clothes")
    const clothes = products
        .filter((product) => product.categoryId === 3) // categoryId: 3 is for Clothes
        .map((product) => ({
            ...
            <div className="text-center my-16">
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-gray-800 to-gray-600">
                        Explore Our Careaux Zelige  Collection
                    </span>
                </h2>
    ...
    // Display only the first clothing item
    const val = clothes[0];
...
export default Section_Clothes;
