        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white/10 backdrop-blur-lg rounded-lg p-6 md:p-10 shadow-xl border border-white/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="mt-1 block w-full px-3 py-2 border border-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  name="email"
                  required
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black"
                />
              </div>
              <div>
          ...
          <div>
            ...
            <div className="text-gray-200 space-y-4">
              <p>
                <strong className="text-white">Mbike Complete</strong>
                <br />
                123 Rue
                <br />
                Fès, 30000
