...
const BikeAboutTown = () => {
  return (
    <div className="flex min-h-screen bg-white-100">
      {/* Sidebar */}
      <div>
        <img src={img} alt="Bike" className="w-full h-auto rounded-lg" />
      </div>

      <div className="flex-1 p-10 text-center text-2xl">
        <h1 className="text-6xl font-bold mb-8 text-gray-800 text-center">
          MBIKE<br />ABOUT<br />TOWN
        </h1>
        <p className="text-xl  text-gray-600 mb-8 font-bold leading-loose">
