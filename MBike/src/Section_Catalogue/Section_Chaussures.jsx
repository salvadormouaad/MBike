...
function Section_Chaussures() {
    const reduxChaussures=useSelector((state)=>{return state.gear.chaussures.mtb.peak_pro});
    return (
        reduxChaussures.map((val,index)=>{
            return  index === 0 && <section key={index} className="bg-black">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                ...
                <div className="hidden w-full h-full lg:mt-0 lg:col-span-5 lg:flex">
                    <img src={val.images.MTB_PEACK_PRO_BLACK_1} alt="mockup" />
                </div>
            </div>
        </section>
        })
...
export default Section_Chaussures;
