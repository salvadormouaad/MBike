...
function Section_Chaussures() {
    const reduxChaussures = useSelector(
        (state) => state.gear.chaussures.mtb.peak_pro
    );
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                            ...
                            <div className="lg:col-span-5 order-1 lg:order-2">
                                <div className="relative w-full max-w-lg mx-auto lg:mx-0 animate-fade-in">
                                    <picture>
                                        <source
                                            srcSet={`${val.images.MTB_PEACK_PRO_BLACK_1}?w=800 800w, ${val.images.MTB_PEACK_PRO_BLACK_1}?w=600 600w`}
                                            media="(min-width: 768px)"
                                        />
                                        <img
                                            src={`${val.images.MTB_PEACK_PRO_BLACK_1}?w=400`}
                                            alt="CUBE Chaussures"
