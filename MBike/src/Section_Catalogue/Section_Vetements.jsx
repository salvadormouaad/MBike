...
function Section_Vetements() {
    const reduxVetements=useSelector((state)=>{return state.gear.vetements.homme.maillots});
    return (
        reduxVetements.map((val,index)=>{
            ...
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                ...
                <div className="hidden w-full h-full lg:mt-0 lg:col-span-5 lg:flex">
                    <img src={val.images.HOMME_MAILLOTS_BLUE_1} alt="mockup" />
                </div>
            </div>
        </section>
        })
