...
function Section_Gants() {
    const reduxGants = useSelector((state) => state.gear.gants.gravity);

    return reduxGants.map((val, index) => {
        return (
            index === 0 && (
                <section
                    key={index}
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                            ...
                            <div className="lg:col-span-5 order-1 lg:order-2">
                                <div className="relative w-full max-w-md mx-auto lg:mx-8 ">
                                    <picture>
                                        <source
                                            srcSet={`${val.images.GRAVITY_OLIVE_1}?w=800 800w, ${val.images.GRAVITY_OLIVE_1}?w=600 600w`}
                                            media="(min-width: 768px)"
                                        />
                                        <img
                                            src={`${val.images.GRAVITY_OLIVE_1}?w=400`}
                                            alt="CUBE Gants"
