...
export default function Slide1() {
  ...
  // Duplicate the shuffled array for seamless looping
        ...
        <div className="carousel-container overflow-hidden relative">
          <div className="carousel-track flex animate-slide">
            ...
            {carouselBikes.map((bike, index) => (
              <div
                key={`${bike.Id}-${index}`} // Use a unique key for each bike
                className="carousel-slide flex-shrink-0 w-72 sm:w-80 md:w-96 bg-white rounded-3xl shadow-md overflow-hidden group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-200 mr-6"
              >
