            ...
            road_race: [
                {
                    ...
                    description:
                        "The Ötztal Cycle Marathon is back again this year, but this time I want to be at the front of the group - and that is why it's all about riding wisely and constantly keeping the pressure on, all over more than 250 km and 5,500 altitude metres. In the end, the reserves are even enough for a little finish sprint in the breakaway group. My helmet? I completely forgot about it after the first kilometres thanks to its great ventilation and perfect fit.",
                    caracteristiques: [
                        "road helmet",
                        "24 large vents",
                        "SILC 180 Fit System with height and width adjustment can be fine-tuned with one hand for a perfect fit",
            ...
            status_x: [
                {
                    ...
                    colors: [],
                    description:
                        "Go beyond your limits; CUBE meets 100% Speed Lab – the expertise of both worlds unites to create a product that's better than ever! We took the amazing 100% STATUS helmet and modified the graphics to match the CUBE colourways to create the perfect complement to our TWO15 and STEREO bikes. Maximum protection for maximum speeds and the gnarliest of terrain.",
                    caracteristiques: [
                        "downhill/mountain bike helmet",
                        "in collaboration with 100% Speed Lab",
                        "ultralight fibreglass shell",
                        "active cooling system",
                        "improved ventilation channels",
                        "removable, washable pads",
                        "perfect fit",
                        "height-adjustable visor",
                        "chin guard with PU padding",
                        "compatible with inflatable helmet system",
                    ],
                    couleur: "BLACK",
            ...
            strover: [
                ...
                },
                {
                    ...
                    caracteristiques: [
                        ...
                        "height-adjustable visor",
                        "Natural Fit concept, matt & glossy finish",
                        "magnetic Fidlock closure",
                        "COOLMAX padding",
                    ],
                    couleur: "BLANC",
            ...
            trooper: [
                ...
                },
                {
                    ...
                    caracteristiques: [
                        "MTB Enduro helmet",
                        "MIPS",
                        "extra coverage at the sides",
                        "21 large ventilation channels",
                        "fixed breakaway visor",
                        "integrated flippable X-Adapter with X-Lock mount",
                        "height-adjustable SILC 180+ Fit System can be adjusted with one hand for the perfect fit",
            ...
            offpath: [
                {
                    ...
                    caracteristiques: [
                        "MTB race helmet for mountain bikers",
                        "19 large vents",
                        "improved ventilation channels",
                        "removable visor",
                        "SNAP 360 Fit System integrated into the MIPS layer with height and width adjustment can be fine-tuned with one hand for a perfect fit",
                        "double in-mould construction",
                        "flat dividers for optimised webbing guiding",
            ...
            stray: [
                {
                    ...
                    caracteristiques: [
                        ...
                        "13 large ventilation channels",
                        "fixed breakaway visor",
                        "integrated X-Lock-Adapter for ACID Accessoires",
                        "light compatible",
                        "height-adjustable Snap 360 Fit System can be adjusted with one hand for the perfect fit",
                        "In-Mould Construction",
                        "Flat Dividers for dual-sided webbing adjustment",
            ...
            pantalon_bretelles: [
                {
                    ...
                    caracteristiques: [
                        "Race Suit designed for cross country",
                        "breathable and quick drying",
                        "durable material bland",
                        "3-part rear pocket for race nutrition",
                        "CUBE Team Pad – made in Italy",
                    ],
                    couleur: "WHITE",
                    materiau: ["85 % polyester", "15 % élasthanne"],
                    taille: "XS-XXXL",
            ...
            sweats_tshirts: [
                {
                    ...
                    colors: ["PETROLE"],
                    description:
                        "Un design décontracté et ample rencontre du coton biologique doux dans ce t-shirt à coupe gravity. Vous n'avez pas besoin de courir pour le porter, mais nous pensons qu'il est parfait pour ces vibrations d'après-course et suffisamment élégant pour être porté partout où vous voulez montrer votre amour pour CUBE.",
                    caracteristiques: [
                        "tissu confortable",
                        "coton biologique",
                        "petit logo brodé sur le devant",
                        "taille du mannequin 182 cm",
            ...
            casquettes_basiques: [
                {
                    ...
                    colors: ["GRIS"],
                    description:
                        "The CUBE Trail Builder Hat is your ideal companion whilst shaping new trails for you and your friends. With its robust material and stylish design, it is ideal for track walks & a cold drink afterwards!",
        ...
        gravity: [
            {
                ...
                caracteristiques: [
                    ...
                    "paume ventilée",
                    "manchette ajustée",
                    "bout des doigts avec imprimé adhérent",
                    "index avec fonction tactile",
                    "construction du bout des doigts sans couture",
                ],
                couleur: "OLIVE",
                materiau: [
                    "main extérieure : 75 % polyester",
                    "15 % nylon",
                    "10 % élasthanne",
                    "paume : 90 % polyester",
                    "10 % élasthanne",
            ...
            peak_pro: [
                {
                    ...
                    materiau: [
                        "upper: PU",
                        "sole: fibre-reinforced nylon, rubber",
                    ],
            ...
            peak: [
                {
                    ...
                    couleur: "BLACK",
                    materiau: [
                        "upper: PU | sole: fibre-reinforced nylon, rubber",
                    ],
                    taille: ["EU 36-48", "UK 3-12.5", "CM 22.5-31.5"],
